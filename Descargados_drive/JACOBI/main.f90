Module Datos
	...
	Implicit none
	Integer, parameter :: n=3     !Dim. Matrix
...
Subroutine Jacobi
	...
	xold=1.d0 !Inicializo todas las raíces
	Error_res=1.d0
	Error_inc=1.d0
	k=1
		...
		If (k<100) then
			...
			Do i=1,n !Filas
				...
				Do j=1,i-1 !Columnas hasta la raíz que estoy calculando
				    Suma=Suma+a(i,j)*xold(j) !Parte inferior de la matriz a, con todas la raíces viejas
				End do 
...
Subroutine Check(k)
	...
	Open(5,File="Raices&Errores.out")
